...
const projects = {
  "machine-stranger": {
    ...
    year: "2025",
    tools: ["Human-Machine Interaction", "Computational Autonomy", "AI Ethics", "Interactive Installation"],
    description:
  ...
  "fleeting-states": {
    ...
    year: "2024",
    tools: ["Multimedia", "LED Mapping", "Quantum Physics", "Science Communication", "Interactive Installation"],
    description:
  ...
  "move-a-bit": {
    ...
    title: "Move A Bit",
    year: "2022",
    tools: ["Quantum Computing", "Motion Capture", "Interactive Installation", "Science Communication"],
    description:
  ...
  "granny-bytes": {
    ...
    title: "Granny Bytes",
    year: "2024",
    tools: ["Cultural Technology", "Conversational UI", "Image Analysis", "Multimodal AI"],
    description:
...
function renderAccordion() {
  ...
  allProjectIds.forEach((projectId, index) => {
    ...
    const pos = (index - currentFeaturedIndex + allProjectIds.length) % allProjectIds.length;
    ...
    const activateCard = (e) => {
      ...
      currentFeaturedIndex = allProjectIds.indexOf(projectId);
        ...
        document.querySelectorAll(".accordion-card").forEach((c) => {
          ...
          const newPos = (originalIndex - currentFeaturedIndex + allProjectIds.length) % allProjectIds.length;
          ...
          if (newPos === 0) {
            ...
            if (video) video.play().catch(e => console.log("Video play prevented:", e));
          } else {
